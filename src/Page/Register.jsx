    ...
    <div className="loginflex">
      ...
      <div className="right-container">
       ...
       <div className="createpass">Create New Password</div> 
        <input type="Password" placeholder='Create New Password' className='border' />
       ...
       <div className="signup">Already have account? <a href='/' className='signreg'>Log in Here</a></div>
